import os
import numpy as np
from process_character.drinkDicts import phrase_dict, character_dict


def load_word_embedding():
    if os.path.exists('/Users/sharoncytheria/Downloads/ME-CNER-master/'
                      'process_character/data_preprocess/drinks/word_embedding_data.txt'):
    ...
    # 将phrase_dict中的词加入到phrase_list中
    ...
    if not os.path.exists('/Users/sharoncytheria/Downloads/ME-CNER-master/'
                          'process_character/data_preprocess/Tencent_AILab_ChineseEmbedding.txt'):
    ...
    with open('/Users/sharoncytheria/Downloads/ME-CNER-master/'
              'process_character/data_preprocess/Tencent_AILab_ChineseEmbedding.txt', 'r',
              encoding='utf-8') as f:
    ...
    with open('/Users/sharoncytheria/Downloads/ME-CNER-master/'
              'process_character/data_preprocess/drinks/word_embedding_data.txt', 'w', encoding='utf-8') as f:
...
def load_char_embedding():
    if os.path.exists('/Users/sharoncytheria/Downloads/ME-CNER-master/'
                      'process_character/data_preprocess/drinks/char_embedding_data.txt'):
    ...
    with open('/Users/sharoncytheria/Downloads/ME-CNER-master/'
              'process_character/data_preprocess/drinks/char_embedding_data.txt', 'w', encoding='utf-8') \
            as f:
        for line in embedding_data:
            f.write(line + '\n')
